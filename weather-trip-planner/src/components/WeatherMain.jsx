  ...
  return (
    ...
    >
      ...
      {!weather ? (
        ...
        <>
          {/* Date & Time */}
          <div className="flex items-center gap-6 text-sm text-gray-300 mb-4 z-10 relative">
            <div className="flex items-center gap-2">
              <HiOutlineCalendarDays className="text-lg text-sky-300" />
              <span>{dayjs().format("MMM D")}</span>
            </div>
            <div className="flex items-center gap-2">
              <HiOutlineClock className="text-lg text-emerald-300" />
          ...
          <div className="flex justify-between items-center mb-4 z-10 relative">
            ...
            <div className="flex items-center gap-3">
              {code && <WeatherIcon code={code} isDay={isDay} size={72} />}
          ...
          {/* Feels like */}
          <div className="text-sm text-gray-200 mb-6 z-10 relative">
            Feels like{" "}
            <span className="font-medium">{weather.feels_like}°C</span>
          </div>

          {/* Weather Details */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm text-white/90 z-10 relative">
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <WiDaySunny className="text-xl text-yellow-300" />
              <span>
                <strong>UV Index:</strong> {weather.uv}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <WiThermometerExterior className="text-xl text-pink-300" />
              <span>
                <strong>Dew point:</strong> {weather.dew_point}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <WiFog className="text-xl text-teal-300" />
              <span>
